import pytest
from usuario.repository import create_user, authenticate_user, get_user_by_email, update_user, delete_user
        ...
        def query(self, model):
            class Query:
                ...
                def filter(self, cond):
                    ...
                    filtered = [u for u in self._users if u.email == email or u.id == cond.right.value]
                    class F:
                        def first(_):
