...
def update_user(user_id: int, user: schema.UserUpdate, db: Session = Depends(get_db), current_user: schema.UserOut = Depends(get_current_user)):
...
def delete_user(user_id: int, db: Session = Depends(get_db), current_user: schema.UserOut = Depends(get_current_user)):
